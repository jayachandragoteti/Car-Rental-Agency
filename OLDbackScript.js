...
function CustomersRegistration() {
  ...
  var formData = {
    ...
    CustomersContactNo: $('#CustomersContactNo').val(),
    CustomersAddress: $('#CustomersAddress').val(),
    bloodGroup: $('#bloodGroup').val(),
    CustomersPassword: $('#CustomersPassword').val(),
    CustomersConfirmPassword: $('#CustomersConfirmPassword').val(),
    CustomersRegistration: 'CustomersRegistration',
  };
  if (
    formData.CustomersName == '' ||
    formData.CustomersEmail == '' ||
    formData.CustomersContactNo == '' ||
    formData.CustomersAddress == '' ||
    formData.bloodGroup == '' ||
    formData.CustomersPassword == '' ||
    formData.CustomersConfirmPassword == '' ||
    formData.CustomersRegistration == ''
  ) {
    $('.alert-bell').removeClass('d-none');
    $('.Customers-Registration-Alerts').html('All fields must be filled!');
  } else {
    $.ajax({
      type: 'POST',
      url: './backScript.php',
...
function updateCustomersProfile() {
  $('.alert-bell').removeClass('d-none');
  $('.Update-Customers-Profile-Alerts').html('Loading...');
  var formData = {
    CustomersName: $('#CustomersName').val(),
    CustomersEmail: $('#CustomersEmail').val(),
    CustomersContactNo: $('#CustomersContactNo').val(),
    ...
    UpdateCustomersProfile: 'UpdateCustomersProfile',
  };
  if (
    formData.CustomersName == '' ||
    formData.CustomersEmail == '' ||
    formData.CustomersContactNo == '' ||
    formData.CustomersAddress == '' ||
    formData.UpdateCustomersProfile == ''
  ) {
    $('.alert-bell').removeClass('d-none');
    $('.Update-Customers-Profile-Alerts').html('All fields must be filled!');
  } else {
    $.ajax({
      type: 'POST',
      url: './backScript.php',
      ...
      success: function (response) {
        $('.alert-bell').removeClass('d-none');
        $('.Update-Customers-Profile-Alerts').html(response);
      },
    });
  }
}
