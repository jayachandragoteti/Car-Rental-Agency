		...
		<div class="container">
			<div class="row">
				<div class="col-sm mt-5">
					...
					<p class="lead text-center text-white font-weight-bold mt-5">A rental car is basically an ..............</p>
		...
		<div class="row">
			<div class="col-lg-6 mt-5">
				<div class="lead text-center mt-5">
					<p>You could drive a rental car until you don't want it.
						...
						<br/> if you're interested. It's now your problem. </p>
				</div>
						...
						<div class="row justify-content-md-center">
							<div class="col-sm-2">
								<select name="city" id="availableCarsCityFilter" class="form-select bg-light mb-2" aria-label="Default select example" onchange="availableCarsResponse()">
									...
									<?PHP 
										$SelectCity = mysqli_query($connect,"SELECT DISTINCT(`city`) FROM `users`");
							...
							<div class="col-sm-2">
								<select name="CarsGroup" id="availableCarsGroupFilter" class="form-select bg-light mb-2" aria-label="Default select example" onchange="availableCarsResponse()">
		...
		<div class="row justify-content-md-center mt-5 jumbotron jumbotron-fluid ">
			<div class="col col-sm-10">
				...
				<div class="table-responsive">
					<p class="fw-bold text-warning d-none alert-bell"><i class="fas fa-bell"></i> <span class="Sample-Request-Alerts"></span></p>
				...
				<div class="py-4 px-4">
					...
					$totalAgencies = mysqli_query($connect,"SELECT * FROM `users` WHERE `loginType` = '0'");
						...
						<div class="col-lg-3 mb-2 pr-lg-1 pb-lg-5 mt-lg-4">
							<div class="row" id="box-search">
								<div class="thumbnail text-center">
									<img src="./assets/images/profilePics/<?PHP echo($totalAgenciesRow['profileImage'] == "") ? 'logo.png':$selectRentalAgencyRow['profileImage'];?>" alt="" class="img-responsive img-fluid rounded shadow-sm img-thumbnail" />
									<div class="captions" >
										<h2 class="text-dark"><?PHP echo $totalAgenciesRow['name'];?></h2>
									</div>
								</div>
							</div>
						</div>
